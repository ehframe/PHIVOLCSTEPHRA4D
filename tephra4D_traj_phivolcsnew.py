...
dir1 = "/home/ehf/PHIVOLCSTEPHRA4D/2026709_files/"  # the directory where the output trajectory file is saved
dir_app = "/home/ehf/PHIVOLCSTEPHRA4D/2026709_files/intp/"  # the directory where the wind and air density data are located
# mapping dem
...
def rise(erno):
    ...
    windstart_utc = pd.to_datetime("2026/7/09 00:00")  # 9 hours: JST - UTC
    ...
    winddat = nc.Dataset(dir_app + "0_2026-07-09_000000_intp.nc", "r")
...
def traj(erno):
    ...
    windstart_utc = pd.to_datetime("2026/7/09 00:00")
    winddat = nc.Dataset(dir_app + "0_2026-07-09_000000_intp.nc", "r")
