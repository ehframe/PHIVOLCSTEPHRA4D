...
end_hour = 14  # 7 hour interval

dir = f"{main_dir}/{date_clear}_{file_hour:04d}/" #input
dir2 = f"{main_dir}/{date_clear}_{file_hour:04d}/extracted/" #output



wrflist = [
    nc.Dataset(f"{dir}wrfout_d02_{date}_{hour:02d}_00_00")
...
ext_nc = nc.Dataset(dir2 + f"{date}_{start_hour:02d}0000_raw.nc", "w",
...
ext_nc_XTIME.units = f"minutes since {date_slash} {start_hour:02d}:00"
